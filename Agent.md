...
**الحالة الحالية:** Phase 0–10.2 اكتملت (الرسوم والأقساط مُكتمَلة وظيفياً وبصرياً ومسارياً عبر البرنامج). المرحلة التالية هي **Phase 11 — Reports and Printing** (تقارير + تصدير PDF عربي RTL عبر QuestPDF + Excel عبر EPPlus/ClosedXML + معاينة قبل الطباعة). لا تبدأ Phase 11 دون طلب صريح من المستخدم.
